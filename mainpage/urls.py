...
from .views import add_todo_task, day_view, delete_todo_task, get_todo_tasks, main_page_view, monthly_stats_view, set_habits_view, update_todo_task, activity_config_view
